...
import { changePage } from "../../../../store/actions-recipes/recipes"
...
export default function Paginado() {
    ...
    let activities = useSelector(state => state.recipe.orderedRecipes)
    // let [[a]] = useSelector(state => state.pagina)
    
    let pages = Math.ceil(activities.length / 8);
    var numberOfPages = []
